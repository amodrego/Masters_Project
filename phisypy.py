...
def get_me_data(timestep, substance, base_file, Z=200):
    ...
    if len(str(timestep)) == 1:
        timestep = '00' + str(timestep)
    elif len(str(timestep)) == 2:
        timestep = '0' + str(timestep)

    if str(timestep) == 'initial':
        xml_file = base_file / 'initial.xml'
        me_file = base_file / 'initial_microenvironment0.mat'
    elif str(timestep) == 'final':
        xml_file = base_file / 'final.xml'
        me_file = base_file / 'final_microenvironment0.mat'
    else:
        xml_file = base_file / 'output00000{}.xml'.format(timestep)
        me_file = base_file / 'output00000{}_microenvironment0.mat'.format(timestep)
